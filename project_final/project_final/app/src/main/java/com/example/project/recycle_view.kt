...
class recycle_view : Fragment() {
    ...
    override fun onCreateView(
        ...
        button.setOnClickListener{
            ...
            builder.setMessage("ต้องการออกจากระบบใช่หรอไม่?")

            builder.setNegativeButton("ใช่",
                DialogInterface.OnClickListener{ dialog, id ->
                    Toast.makeText(this.context,"ออกจากระบบสำเร็จ", Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
            ...
            builder.setPositiveButton("ไม่ใช่",
                DialogInterface.OnClickListener{ dialog, id ->
                    Toast.makeText(this.context,"คงอยู่ในระบบ", Toast.LENGTH_SHORT).show()
                    dialog.dismiss()
